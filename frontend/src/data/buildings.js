...
// ── 표시 전용 건물 (rentable: false → 클릭 불가, 지도에 폴리곤만 표시) ──
{
  key: 'arts',
  name: '예술관',
  info: '미술실 · 음악실 · 전시홀 · 1~3층',
  rentable: false,
  points: '207,122 207,141 200,146 200,155 204,162 236,154 266,146 264,113 256,99 248,91 235,95 224,109',
}, {
  key: 'student-center',
  name: '학생회관',
  info: '동아리방 · 매점 · 휴게실 · 1~4층',
  rentable: false,
  points: '609,287 609,310 602,316 605,324 619,330 681,303 681,271 669,259',
}, {
  key: 'engineering',
  name: '공학관',
  info: '전자공학 · 기계공학 · 실험실 · 1~3층',
  rentable: false,
  points: '652,345 652,353 652,394 653,404 666,416 711,396 710,351 715,348 713,338 696,324',
}, {
  key: 'startup',
  name: '산학협력관',
  info: '창업보육센터 · 산학연구실 · 1~4층',
  rentable: false,
  points: '772,309 769,330 779,338 795,332 802,337 797,344 799,363 807,375 821,375 847,354 845,334 833,317 800,295 789,296',
}];
...
export const ROOM_TYPE_LABELS = {
  ...
  COURT: '구기장', GYM: '피트니스', LAB: '실습실', OUTDOOR: '야외시설', POOL: '수영장', RACQUET: '라켓스포츠', SEMINAR: '세미나실',
};
