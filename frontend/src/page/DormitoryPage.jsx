...
import {fetchDormRooms, applyDorm} from '../data/api.js';
  ...
  return (<div id="dormitoryView">
    ...
    <div className="breadcrumb-nav">
      <div className="container">
        ...
        <a href="#" onClick={e => { e.preventDefault(); navigate('/'); }}>캠퍼스 지도</a>
        <span className="sep">/</span>
        {selectedGender ? (<>
          <a href="#" onClick={e => { e.preventDefault(); setSelectedGender(null); }}>기숙사</a>
          <span className="sep">/</span>
        ...
        <div className="floor-detail">
          {currentFloorData ? (<>
            ...
            <div className="dorm-status-legend">
              <div className="dorm-legend-item"><div className="dorm-legend-dot" style={{background: '#c6f6d5'}}/>빈방 (0/2)</div>
              <div className="dorm-legend-item"><div className="dorm-legend-dot" style={{background: '#fefcbf'}}/>1명 (1/2)</div>
              <div className="dorm-legend-item"><div className="dorm-legend-dot" style={{background: '#fed7d7'}}/>만실 (2/2)</div>
            </div>
    ...
    <div className="dorm-room-card" style={{background: bgColor, borderColor}}>
      <div className="dorm-room-header">
        ...
        <div className="dorm-room-occ">
          <span className="room-status-dot" style={{background: dotColor, display: 'inline-block', width: 8, height: 8, borderRadius: '50%', marginRight: 4}}/>
